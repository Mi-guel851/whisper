 ...
 * index.ts and nothing else. If a `userId` field ever shows up in a request
 * body, it is ignored here rather than read.
 */
...
function parseHistory(value: unknown): ChatTurn[] {
  ...
  /* Keep the most recent turns, and make sure the window starts on a user turn
     ...
     some chat templates reject that outright. */
