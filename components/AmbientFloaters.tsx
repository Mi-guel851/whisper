...
const FLOATERS: Floater[] = [
  { emoji: "💜", left: 8,  size: 1.5,  delay: -2,  duration: 17, drift: 26,  peak: 0.5 },
  { emoji: "✨", left: 21, size: 1.0,  delay: -9,  duration: 21, drift: -18, peak: 0.34 },
  { emoji: "❤️", left: 34, size: 1.25, delay: -14, duration: 19, drift: 32,  peak: 0.42 },
  { emoji: "👻", left: 47, size: 1.75, delay: -5,  duration: 24, drift: -28, peak: 0.3 },
  { emoji: "💬", left: 61, size: 1.1,  delay: -18, duration: 20, drift: 22,  peak: 0.36 },
  { emoji: "💜", left: 75, size: 1.35, delay: -11, duration: 16, drift: -24, peak: 0.46 },
  { emoji: "✨", left: 89, size: 0.95, delay: -7,  duration: 23, drift: 16,  peak: 0.32 },
];
