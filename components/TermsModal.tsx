    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/85 backdrop-blur-sm p-4">
      <GlassPanel strong className="w-full max-w-md rounded-3xl p-8">
        ...
        <button
          ...
          disabled={loading}
          className="mt-8 w-full rounded-2xl bg-gradient-to-r from-purple-500 to-purple-500 p-4 font-bold text-black transition hover:opacity-90 disabled:opacity-60"
        >
