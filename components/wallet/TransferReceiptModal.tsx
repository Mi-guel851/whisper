...
import { TransferReceipt, formatTransferTimestamp } from "@/lib/wallet";
...
export default function TransferReceiptModal({
  ...
  // A receipt fetched from history can be either side of the transfer; a fresh
  // one is always outgoing, since only the sender initiates.
    ...
    >
      {receipt && (
        <div className="px-5 pb-6 pt-6 sm:px-6">
          ...
          >
            <Row label="Transaction type" value="Coin Transfer" />
