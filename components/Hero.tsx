...
export default function Hero() {
  return (
    <section className="relative mx-auto flex min-h-screen max-w-5xl flex-col items-center px-4 pt-28 pb-16 text-center sm:px-8 sm:pt-40 sm:pb-24">
      ...
      <div className="mb-6 inline-flex max-w-full flex-wrap items-center justify-center gap-2 rounded-full border border-purple-600/20 bg-purple-600/10 px-4 py-2 text-xs text-purple-400 sm:px-5 sm:text-base">
      ...
      <div className="mt-8 flex w-full flex-wrap items-center justify-center gap-4 sm:mt-10 sm:w-auto sm:gap-5">
        <Link
          href="/signup"
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-purple-600 to-purple-600 px-8 py-4 font-bold text-white transition hover:scale-105 sm:w-auto"
        >
          Create my link
          <ArrowRight size={18} />
        </Link>
