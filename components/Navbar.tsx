    ...
    <header className="sticky top-0 z-50">
      <nav className="mx-auto mt-6 flex max-w-7xl items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-6 py-4 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/login"
            className="rounded-xl px-5 py-2 text-gray-300 transition hover:text-white"
          >
            Login
          </Link>
          ...
          <Link
            href="/signup"
            className="rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 px-5 py-2 font-semibold text-white transition hover:scale-105"
          >
            Create Link
          </Link>
